...
// SQUARE SORTED ARRAY -> RESOLVER COM TWO POINTERS
// comece colocando ao contrarios os numeros
// Output: [0,1,9,16,100]
let nums = [-4,-1,0,3,10]
...
//CHECK IF IT'S PALINDROME - JUNTE TUDO E TIRE OS ESPAÇOS E VIRGULAS E PONTOS e coloque em lowerCase
// .replace(/[^a-z0-9]/g, '')
...
// obs -> calculate the maximium area and min height of the walls because the water cannot overflow the wall
...
// compare if max_left < max_right
// andamos um e comparamos curr(o que andamos) com o previous
...
let nums3 = [1,0,-1,0,-2,2], target3 = 0
